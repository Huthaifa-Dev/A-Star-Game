...
def astar(maze, start, end):
    ...
    while len(open_list) > 0:
        ...
        for child in children:
            ...
            # print(child.g)
            print(child.position,child.f,child.g)
...
def main():
    ...
    maze = [[2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2],
    ...
    print(maze)       
    for array in maze:
        new_row = [1 if x == 2 else 0 for x in array]
        print(new_row)
        maze[maze.index(array)]= new_row
    print(maze)
    start = (1, 1)
    end = (3, 5)
